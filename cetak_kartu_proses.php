...
<table class="print" border="0" align="center" bgcolor="whitegreen">
		...
		<th colspan="2" width="100" >ORGANISASI PECINTA KESENIAN INDONESIA </th>
		<tr>
		...
		<td colspan="2"><strong><?= $dta['nama'] ?> <br/>
			...
			<tr>
				<td align="center" colspan="3">
					<i><h6>dimaspandu@copyright2022</h6></i>
				</td>
			</tr>
		</td>
		<tr>
...
<table class="print" border="0" align="center"  bgcolor="whitegreen">
		...
		<th colspan="2" width="100" >ORGANISASI PECINTA KESENIAN</th>
		<tr>
		<td colspan="2"><strong>__________________________________</strong></td>
	</tr>
	<tr >
