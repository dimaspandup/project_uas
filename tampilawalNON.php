...
<form action="" method="post">
	<table class="table" >
		...
		<tr>
			...
			<td></td>
			<td>
				<input  class="form-control" type="text" name="Instasi" placeholder="Asal Instasi" size="30">
			</td>
		</tr>
		<tr>
			<td>Tujuan</td>
			...
			<td>
				<select  class="form-control" name="Tujuan"> 
					...
					<option>Pengembangan Wawasan</option>
...
<?php 
 if (isset($_POST['tambah'])){
 	...
 	if ($nama == '' || $Alamat =='' || $Tujuan ==''){
 		...
 		$simpan = mysqli_query($konek , "INSERT INTO tamu VALUES (null,'$nama','$Alamat', '$Asal Kota' ,'$tglkunjung', '$Tujuan')
 			");
 		if ($simpan){
 			echo "
 		<script>
 		alert('data berhasil disimpan');
 		alert('SELEMAT DATANG DI ORGANISASI PECINTA KESENIAN INDONESIA');
 		document.location.href = 'tampilawalNON.php';
 		</script>
 		";
 		}else {
